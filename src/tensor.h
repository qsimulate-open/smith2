...
class Tensor {
  ...
  public:
    ...
    bool index_initialized() const { return index_initialized_; }
    ...
    bool in_list(const std::vector<std::shared_ptr<Tensor>> vect) const {
    ...
    bool in_regtensors() const { return in_list(regtensors_); }
    ...
    bool identical(std::shared_ptr<Tensor>) const;
